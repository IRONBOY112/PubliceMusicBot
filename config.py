...
LOGGER_ID = int(getenv("LOGGER_ID", "-4831955878"))  # Chat id of a group for logging bot's activities/ Music Play Logs
...
GBANLOGS = int(getenv("GBANLOGS", "-4831955878")) #Add Here Your Gbans Logs Channel Id 
